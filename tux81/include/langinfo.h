...
/* #ident	"@(#) gp/libgp/i18n/langinfo.h	$Revision: 1.5 $" */
#ifndef TMENV_H
#include <tmenv.h>
#endif

#ifndef NOWHAT
static	char	langinfo_h[] = "@(#) gp/libgp/i18n/langinfo.h	$Revision: 1.5 $";
#endif
...
_TMDLLENTRY
#ifndef __linux__
nl_langinfo(nl_item);	/* get a string from the database	*/
#else
gp_nl_langinfo(nl_item);   /* get a string from the database       */
#define nl_langinfo(nl_item) gp_nl_langinfo(nl_item)
#endif
#if defined(__cplusplus)
}
#endif
...
#else
char   *gp_nl_langinfo();         /* get a string from the database       */
#define nl_langinfo() gp_nl_langinfo()
#endif
#endif
