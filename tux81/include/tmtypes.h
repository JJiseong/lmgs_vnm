...
#ifndef TMTYPES_H
#define TMTYPES_H
/* #ident	"@(#) tuxedo/include/tmtypes.h	$Revision: 1.8 $" */

#ifndef TMENV_H
#include <tmenv.h>
#endif
#ifndef NOWHAT
static	char	h_tmtypes[] = "@(#) tuxedo/include/tmtypes.h	$Revision: 1.8 $";
#endif
...
struct tmtype_sw_t {
	...
	long (_TMDLLENTRY *mbconv) _((char _TM_FAR *, long, char _TM_FAR *, char _TM_FAR *, long, long _TM_FAR *));
...
extern	long	_tmconvmb _((char *, long, char *, char *, long, long *));
#endif
...
extern  long    _TMDLLENTRY _mbsconv _((char _TM_FAR *, long, char _TM_FAR *, char _TM_FAR *, long, long *));
extern  long    _TMDLLENTRY _fmbconv32 _((char _TM_FAR *, long, char _TM_FAR *, char _TM_FAR *, long, long *));
