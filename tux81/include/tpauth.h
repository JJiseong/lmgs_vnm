...
#ifndef TPAUTH_H
#define TPAUTH_H
/* #ident	"@(#) tuxedo/include/tpauth.h	$Revision: 1.4 $" */

#ifndef TMENV
#include <tmenv.h>
#endif
#ifndef NOWHAT
static	char	h_tpauth[] = "@(#) tuxedo/include/tpauth.h	$Revision: 1.4 $";
#endif
...
extern int	_encr_protected _((char *in, char *out, int length, TMSEC_KEY *oldkey, int has_oldkey));
